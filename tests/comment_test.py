...
class TestPitch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_pitch = Pitch(content = "This is my pitch", category='Business',user=self.user_joe)
        self.new_comment = Comment(comment= "This is my comment", pitch=self.new_pitch, user=self.user_joe)
    ...
    def test_check_instance_variables(self):
        self.assertEquals(self.new_comment.comment,"This is my comment")
